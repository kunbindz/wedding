<template>
    <div>
        <section id="mempelai">
            <div
                class="sm:tw-max-w-screen-sm md:tw-max-w-screen-md lg:tw-max-w-screen-lg tw-mx-auto tw-px-2.5 tw-py-10">

                <p class="tw-text-sm lg:tw-font-semibold tw-font-normal tw-text-center w-py-2">Assalamualaikum
                    warahmatullahi wabarakatuh</p>
                <p
                    class="tw-text-sm tw-leading-relaxed lg:tw-font-semibold tw-font-normal tw-text-justify md:tw-text-center lg:tw-hidden tw-py-4 tw-mb-10">
                    Dengan memohon rahmat dan ridho-Mu Ya
                    Allah, Kami bermaksud mengadakan acara pernikahan putra dan putri kami.
                </p>
                <p
                    class="tw-hidden lg:tw-block tw-leading-relaxed tw-text-sm lg:tw-font-semibold tw-font-normal tw-text-justify md:tw-text-center tw-py-4 tw-mb-16">
                    Dengan memohon rahmat dan ridho-Mu Ya
                    Allah, <br> Kami bermaksud mengadakan acara pernikahan putra dan putri kami.
                </p>
                <div class="lg:tw-w-4/5 lg:tw-mx-auto">
                    <div
                        class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 sm:tw-gap-4 md:tw-gap-2 lg:tw-gap-6 tw-mx-auto">
                        <div class="tw-text-center">
                            <div class="pl tw-mx-auto">
                            </div>
                            <h2 class="tw-py-3 m-name tw-text-1xl sm:tw-text-lg md:tw-text-1xl lg:tw-text-2xl">Trần Xuân
                                Lộc</h2>
                        ...
                        <div class="tw-text-center">
                            ...
                            <h2 class="tw-py-3 m-name tw-text-1xl sm:tw-text-lg md:tw-text-1xl lg:tw-text-2xl">Lita
                                Luthfiyyani, S.H.</h2>
