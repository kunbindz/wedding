        ...
        <section class="tw-bg-cover tw-bg-center"
            ...
            <div class="outer-cover tw-px-2.5 tw-pt-5 tw-pb-16">
                <div class="tw-p-4">
                    ...
                    <div class="tw-py-4">
                        <h2 class="tw-text-4xl lg:tw-text-5xl tw-text-center tw-font-light uk-scrollspy-inview">Xuân Lộc & Hương Cúc</h2>
                    </div>
                    <p class="tw-text-center tw-font-light tw-text-xs lg:tw-text-lg lg:tw-font-normal uk-scrollspy-inview"
                        style="color: #bdaa8b; letter-spacing: 3px;">05.09.2022</p>
                </div>
            </div>
        </section>
    </div>
